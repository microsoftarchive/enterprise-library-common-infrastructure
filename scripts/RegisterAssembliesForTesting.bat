...
@REM
@REM  This batch file installs/uninstalls the assemblies for Common Infrastructure Library.
@REM  By default it installs the assemblies in the debug dirs.
@REM  
...
echo ("%InstallUtilDir%".) 
echo.
echo If you have installed the .NET Framework v4.5 to a different location, you will need 
